        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-[#64748b]">v0.1.0 · Elastic License 2.0</span>
            </div>
            <div className="flex items-center gap-6">
              ...
              <Link href="https://github.com/frisky1985/yuleOSH" target="_blank" className="text-xs text-[#64748b] hover:text-[#94a3b8] transition-colors">GitHub</Link>
            </div>
          </div>
        </div>
      </footer>

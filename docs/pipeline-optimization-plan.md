...
| **G-46** | **三轮** | **P0 🔴 追溯完整性** | **🆕 新增** | LRM/LRT 工具链集成，追溯评分 35→目标 60 |
...
| P0 | **G-46: 追溯完整性自动化** | **3~4 人天（短期）** | 🔴 **L2 + ASPICE CL1** | **🆕 三轮新增——LRM/LRT 工具链，评分 35→目标 60** | **Sprint 2** |
...
Sprint 2 (当前 Sprint)
  ...
  ├── G-46 追溯完整性自动化           ⬅ 🆕 三轮新增——从 35 分起步，目标 60 分
...
| **三轮** | **G-34~G-40 深度补缺（7 项）** | **76/100** | **↗ +6，嵌入式 Agent 审查深度显著提升** |

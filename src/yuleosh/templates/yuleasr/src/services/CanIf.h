/**
 * @file CanIf.h
 * @brief CAN Interface — PDU routing between CAN driver and upper layers (reference: services layer)
 *
...
extern void CanIf_TxConfirmation(PduIdType pduId);
extern void CanIf_RxIndication(PduIdType pduId);
#ifdef __cplusplus
}
#endif

 ...
 *          In production, set GENERIC_TASK_FAULT_INJECT_ENABLE = STD_OFF.
 ******************************************************************************/

#ifndef GENERIC_TASKFAULTINJECT_CFG_H_
#define GENERIC_TASKFAULTINJECT_CFG_H_
 ...
 *=========================================================================*/
#define GENERIC_TASK_FAULT_INJECT_ENABLE    (STD_OFF)
...
#define GENERIC_TASK_FAULT_SIM_NULL_HANDLE       (STD_ON)
#define GENERIC_TASK_FAULT_SIM_INVALID_PARAM     (STD_ON)
#define GENERIC_TASK_FAULT_SIM_TIMEOUT           (STD_ON)
#define GENERIC_TASK_FAULT_SIM_QUEUE_FULL        (STD_ON)
#define GENERIC_TASK_FAULT_SIM_BUFFER_OVF        (STD_ON)
#define GENERIC_TASK_FAULT_SIM_RESOURCE_LOST     (STD_ON)
#define GENERIC_TASK_FAULT_SIM_STATE_CORRUPT     (STD_ON)
#define GENERIC_TASK_FAULT_REAL_STACK_DEPLETE    (STD_OFF)  /* Risky — may cause real overflow */
 ...
 *=========================================================================*/
#define GENERIC_TASK_FAULT_INJECT_UDS_DID        (0xF193U)
#define GENERIC_TASK_FAULT_INJECT_UDS_SEC_LEVEL  (0x01U)

#endif /* GENERIC_TASK_FAULT_INJECT_ENABLE == STD_ON */

#endif /* GENERIC_TASKFAULTINJECT_CFG_H_ */
